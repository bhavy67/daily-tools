        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mb-12 sm:mb-16">
            ...
            <div className="block h-full group">
              <div className="h-full p-4 sm:p-5 lg:p-6 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-900/20 dark:via-purple-900/20 dark:to-pink-900/20 rounded-xl sm:rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-300 border-2 border-dashed border-indigo-300 dark:border-indigo-700 hover:border-indigo-500 dark:hover:border-indigo-500 hover:-translate-y-1 sm:hover:-translate-y-2 hover:scale-[1.01] sm:hover:scale-[1.02]">
                <div className="flex flex-col h-full">
                  <div className="flex items-start space-x-3 sm:space-x-4 mb-auto">
                    <div className="flex-shrink-0">
                      <div className="relative">
                        <div className="p-2 sm:p-2.5 lg:p-3 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-lg sm:rounded-xl group-hover:scale-110 transition-all duration-300">
                          <span className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xl sm:text-2xl">✨</span>
                        </div>
                        <div className="absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-yellow-400 rounded-full flex items-center justify-center animate-bounce">
                          <span className="text-[10px] sm:text-xs">🚀</span>
                        </div>
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-base sm:text-lg font-heading font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent mb-1.5 sm:mb-2 line-clamp-1">
                        More Tools Coming Soon!
                      </h3>
                      <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 line-clamp-2 leading-relaxed min-h-[2.5rem] font-sans">
                  ...
                  <div className="mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-indigo-200 dark:border-indigo-700/50">
                    <span className="inline-flex items-center px-2.5 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs font-semibold text-indigo-700 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/40 rounded-lg font-heading tracking-wide gap-1.5">
